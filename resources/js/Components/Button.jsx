...
export default function Button() {
    ...
    return (
        <>
            ...
            {type === 'submit' &&
                <Link href={url} className="px-4 py-2 text-sm rounded-lg border border-teal-100 bg-teal-50 text-teal-500 flex items-center gap-2 hover:bg-teal-100">
            ...
            {type === 'edit' &&
                <Link href={url} className="px-4 p-2 rounded-lg bg-orange-50 text-orange-500 flex items-center gap-2 hover:bg-orange-100" >
